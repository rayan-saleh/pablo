...
import type { InspectorMode, InspectorStatus } from '../shared/types';
    ...
    <div className="p-4 space-y-4">
      ...
      {stack && (
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium px-2 py-0.5 rounded bg-purple-100 text-purple-700 capitalize">
            {stack}
          </span>
        </div>
      )}
