...
export const metadata: Metadata = {
  ...
  description:
    "Pablo is a Chrome extension that lets you hover over any component, click, and get production-ready HTML + CSS on your clipboard.",
};
...
function Footer() {
  return (
    <footer className="border-t border-white/5 py-12">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-6 text-sm text-zinc-500">
